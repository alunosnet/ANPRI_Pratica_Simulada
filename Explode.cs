...
public class Explode : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Invoke("Explosao", 2);  //invoca a função passados 2 segundos
    }
    ...
    public void Explosao()
    {
        ...
        {
            if (obj is CharacterController) continue;   //para evitar tirar vida ao player duas vezes
            //se tem ridigbody
        ...
        {
            efeitoExplosao = Instantiate(efeitoExplosao,transform.position,Quaternion.Euler(-90,0,0));
            efeitoExplosao.Play();
        }
